 ...
 */
public final class VegasLimit extends AbstractLimit {
    ...
    private volatile long rttNoload;
    ...
    public String toString() {
        return "VegasLimit [limit=" + getLimit() + 
                ", rtt_noload=" + TimeUnit.NANOSECONDS.toMicros(rttNoload) / 1000.0 +
                " ms]";
    }
}
